...
const FAQPage: React.FC<FAQPageProps> = ({ faqs, contact }) => {
  ...
  // Sanitize phone for tel: link (removes spaces, brackets, and vanity letters like SMS)
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="bg-slate-900 pt-32 pb-24 text-white relative overflow-hidden text-center">
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-4xl">
          ...
          <p className="text-slate-400 text-xl font-medium max-w-2xl mx-auto">Find answers to common questions about enrollment, curriculum, and placement services.</p>
      ...
      <div className="container mx-auto px-4 py-20 max-w-4xl">
                  ...
                  return (
                    <div key={faq.id} className="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden transition-all hover:shadow-xl">
                      ...
                      >
                        ...
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 transition-all ${isOpen ? 'bg-emerald-600 text-white rotate-45' : 'bg-slate-50 text-slate-400 group-hover:bg-emerald-50'}`}>
        ...
        <div className="mt-20 p-12 bg-slate-900 rounded-[3rem] text-center text-white relative overflow-hidden group">
          {/* pointer-events-none added to ensure the glow doesn't block the buttons */}
